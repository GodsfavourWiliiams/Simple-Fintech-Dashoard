...
import { closeMessageActionCreator } from "../../logic/reducers/notificationSlice";
...
const Notification = () => {
  ...
  useEffect(() => {
    if (type && open) {
      setTimeout(() => dispatch(closeMessageActionCreator()), 5000);
    }
  }, [dispatch, open, type]);
  ...
  return (
    <>
      {type === "success" && (
        <div
          className="absolute top-0 transition-all ease-in-out flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 "
          role="alert">
          <svg
            aria-hidden="true"
      ...
      {type === "warning" && (
        <div
          className="absolute top-0 transition-all ease-in-out flex p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50 "
          role="alert">
          <svg
            aria-hidden="true"
            className="flex-shrink-0 w-5 h-5"
      ...
      {type === "error" && (
        <div className="absolute top-0 transition-all ease-in-out flex p-4 mb-4 text-red-800 rounded-lg bg-red-50">
          <svg
            aria-hidden="true"
            className="flex-shrink-0 w-5 h-5"
            fill="currentColor"
